...
const Map = () => {
  ...
  useEffect(() => {
    ...
    map.loadImage("http://localhost:3000/building-texture.jpg", function (error, image) {
    ...
    map.on('load', () => {
      ...
      map.addLayer({
        ...
        onAdd: function (map, mbxContext) {
          ...
          for (const v of ListBuilding) {
            ...
            window.tb.loadObj(building, function (model) {
      ...
      //     let options = {
      //       type: "obj",
      //       obj: "building/Rv_Building_3.obj",
      //       scale: 1,
      //       units: "meters",
      //       anchor: 'center',
      //       adjustment: { x: 0, y: 0, z: 0 },
      ...
      //       const a = model.setCoords(origin);
      //       a.wireframe = true;
      //       window.tb.add(a);
      ...
      //       // "fill-extrusion-pattern": { property: "height", type: "interval", stops: [[400, textureName]] },
